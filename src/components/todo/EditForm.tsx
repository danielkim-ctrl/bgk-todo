...
import { ArrowPathIcon, DocumentTextIcon, ICON_SM } from "../ui/Icons";
...
export function EditForm({f,onChange,proj,members,pris,stats}: {
  ...
  return <>
    ...
    <div style={{marginBottom:12}}><label style={{fontSize:11,fontWeight:600,color:"#334155",display:"flex",alignItems:"center",gap:3,marginBottom:4}}><ArrowPathIcon style={ICON_SM}/> 반복</label>
